            ...
            <form class="formEdit" action="" method="POST">
                <fieldset class="border p-3">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="password" class="form-control col-7" id="password-edit" name="password-edit" value="<?php echo $password; ?>" readonly>
                    </div>
                    <div class="form-group row">
                        <label class="col-3 text-right col-form-label" for="year-edit">Phone:</label>
                        <input type="number" class="form-control col-7" id="phone-edit" name="phone-edit" value="<?php echo $phone; ?>">
                    </div>
                    <div class="form-group row">
                        <div class="offset-3">
